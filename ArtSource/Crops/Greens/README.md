...
- 原始6776面中5776四边面（85.2%），三角化12552；原模、高低整理网格均0开边／非流形边、0零面积面、0孤点。高档完整保留 **12552三角**，无减面；辅助低档 **8158三角**。同日按用户反馈将主叶轴扶正约21°，刚性旋转烘焙进高低档几何及法线、根部落地，保留自然展开。现宽.3785／高.4532／深.4706米，无缩放变形。原生4K色图、单材质、roughness .97／metallic 0／specular .08；原始FBX不可变，重建同步应用 [扶正矩阵](p2-gongbi-20260918/upright-transform.json)。源和重导入审计见 [asset-audit.json](p2-gongbi-20260918/asset-audit.json)。
