...
操作：第二行直接选菜，悬停土地预览小格，左键点击播种；可连续种植，拿着种子时滚轮切换菜种。选择浇水或收获工具后同样点击目标格执行。右键、Esc 或取消按钮放下工具，滚轮恢复缩放。空手点击大田靠近，中键微调角度，Shift + 中键平移。“全景”返回，“复位”恢复构图。自由视角左键绕点击处旋转，中键／右键平移，滚轮缩放。“布置”处理已解锁装饰；“设置”包含音量、显示、操作与来源。历史候选包的随包说明仅对应其自身版本。
