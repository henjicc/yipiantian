...
当前本地候选 **0.1.0-rc.4** 对应源码 `8d592e9adb2a290491b0077c61fddbbc3a5f4f8a`：柔边阴影、草土与根部融合、圆润河石、船岸与舱内水面修正、长藤架和较轻景深。长架下土床预留后续攀爬作物，目前仍为六田96格、两种作物、v3存档。独立干净构建及PCK资源审计通过；仓库外中文／空格路径的普通程序已验证选格、播种、浇水、保存重开、继续生长和正常退出。相关画面／输入回归、1080p烟测164项、4K六组56项通过，性能边界见[开发准备](docs/development-setup.md)。本地包为 `制作留档/06_发行候选/0.1.0-rc.4-8d592e9a/我有一片田 0.1.0-rc.4 Windows.zip`，SHA-256 `f7a4082a4fb5e87314ea6fa638560879b64c501b81988f064533966ca8e8ee5d`；旁有构建、原生验收及画面证据。019号24秒4K60有声离线演示已留档，1440帧、音画等长、运动检查通过，非实时性能证明。未发布到商店或远端。
