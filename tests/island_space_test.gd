...
func _run() -> void:
	...
	plan=Plan.new()
	expect(plan.apply_construction({"east_land":[],"land":[[-2,5,4,5],[-4,5,3,5]],"trellis":[],"bridge":[],"buildings":{"house":[],"kitchen":[]},"flocks":preload("res://layout/flock_layout.gd").initial()}),"Connected extension supports the planting fixture")
